...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
                ...
                drivetrain.applyRequest(() -> drive.withVelocityX(joystick.getLeftY() * DrivetrainConst.MaxSpeed) // Drive forward with
                                                                                                   // negative Y
                                                                                                   // (forward)
                        .withVelocityY(joystick.getLeftX() * DrivetrainConst.MaxSpeed) // Drive left with negative X (left)
                        .withRotationalRate(joystick.getRightX() * DrivetrainConst.MaxAngularRate) // Drive counterclockwise with
                                                                                    // negative X (left)
                ));
